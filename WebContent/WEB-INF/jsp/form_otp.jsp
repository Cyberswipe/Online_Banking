	...
	<body>
		...
		<div align="center">
			<div style="width: 700px; border-style:solid;">
				<div align="left" style="transform: translateY(20px);"><font size="4px"><b>Validate Email Address</b></font></div><div align="right" style="transform: translateY(-20px);"><a href="restore_personal_details" class="btn btn-info btn-lg"><span class="glyphicon glyphicon-circle-arrow-left"></span> Go Back</a></div>
				<hr>
				A One Time Passcode has been sent to <strong><%= session.getAttribute("form_email") %></strong><br><br>
				...
				<form method="post">
					...
					<br><br>
					<input type ="submit" value="Validate OTP" formaction="validateFormOTP" class="btn btn-success btn-lg"><br><br>
				</form>
				<form method="post"><input type ="submit" value="Resend OTP" formaction="resendFormOTP" class="btn btn-warning btn-lg"><br><br></form>
			</div>
		</div>
